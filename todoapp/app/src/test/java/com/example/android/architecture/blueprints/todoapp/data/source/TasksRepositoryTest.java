...
//
//   @Spy
//   private TasksDataSource mTasksRemoteDataSource = Injection.provideFakeTasksRepository();
//
//   @Spy
//   private TasksDataSource mTasksLocalDataSource = Injection.provideFakeTasksRepository();
//
//   @Mock
...
//      mTasksRepository.getTasks().subscribe(new TestSubscriber<ArrayList<Task>>()); // First call to API
//
